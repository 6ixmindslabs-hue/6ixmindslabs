                ...
                <div className="flex gap-4 items-center">
                    <div className="relative group">
                        ...
                        <select
                            ...
                            className="pl-12 pr-6 py-4 bg-white border border-gray-100 rounded-2xl text-[10px] font-black uppercase tracking-widest text-gray-500 focus:outline-none focus:ring-4 focus:ring-brand-purple/10 transition-all appearance-none cursor-pointer shadow-sm"
                        >
