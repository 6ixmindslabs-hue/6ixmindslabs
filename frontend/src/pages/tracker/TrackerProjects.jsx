    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-4xl font-black text-gray-800 tracking-tighter">Project Management</h1>
            ...
            <div className="bg-white border border-gray-100 rounded-[32px] p-8 shadow-sm space-y-6">
                <div className="relative group">
                    ...
                    <input
                        type="text"
                        placeholder="IDENTIFY PROJECTS BY TITLE, CLIENT OR DOMAIN..."
                        value={searchQuery}
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/60 backdrop-blur-xl">
                        ...
                        >
                            <div className="p-10 border-b border-gray-100 flex items-center justify-between bg-gradient-to-br from-gray-50 via-white to-gray-50/50">
                                <div>
                                    <h2 className="text-4xl font-black text-gray-800 tracking-tighter">{editingId ? 'Modify Project' : 'Initiate New Project'}</h2>
                                    <p className="text-[10px] text-brand-purple font-black uppercase tracking-[0.3em] mt-2 opacity-60">Operations & Lifecycle Management</p>
                                </div>
                                <button onClick={() => setShowAddModal(false)} className="p-5 hover:bg-gray-100 rounded-[28px] transition-all group">
                                    <X className="w-8 h-8 text-gray-300 group-hover:text-gray-800 transition-all" />
                                </button>
                            </div>

                            <form onSubmit={handleSubmit} className="p-12 space-y-10 overflow-y-auto max-h-[70vh]">
