    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-4xl font-black text-gray-800 tracking-tighter">Unified Training Database</h1>
                    <p className="text-gray-500 font-medium text-sm mt-1 uppercase tracking-widest opacity-60">Sixminds Labs Operations Control</p>
                </div>
                <div className="flex gap-4">
                    <button
                        onClick={repairFinancialLedger}
                        className="px-6 py-4 bg-white border border-gray-100 text-gray-400 rounded-2xl text-[11px] font-black hover:bg-gray-50 transition-all flex items-center gap-2 uppercase tracking-wider"
                    ...
                    <button
                        ...
                        className="px-8 py-4 bg-gradient-to-r from-brand-purple to-brand-pink text-white rounded-2xl text-[13px] font-black shadow-xl shadow-brand-purple/30 hover:scale-[1.03] active:scale-95 transition-all flex items-center gap-3 uppercase tracking-wider"
                    >
            ...
            <div className="bg-white border border-gray-100 rounded-[32px] p-6 shadow-sm">
                <div className="relative group">
                    ...
                    <input
                        type="text"
                        placeholder="SEARCH BY EVERYTHING (NAME, ID, PHONE, EMAIL, BATCH, DOMAIN)..."
                        value={searchQuery}
            ...
            <AnimatePresence>
                {showAddModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/60 backdrop-blur-xl">
                        <motion.div initial={{ opacity: 0, y: 100, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 100, scale: 0.9 }} className="bg-white rounded-[48px] shadow-2xl w-full max-w-3xl overflow-hidden border border-white/20">
                            <div className="p-10 border-b border-gray-100 flex items-center justify-between bg-gradient-to-br from-gray-50 via-white to-gray-50/50">
                                <div>
                                    <h2 className="text-4xl font-black text-gray-800 tracking-tighter">{editingId ? 'Modify Ledger' : 'Create Registry'}</h2>
                                ...
                                <button onClick={() => setShowAddModal(false)} className="p-5 hover:bg-gray-100 rounded-[28px] transition-all group border border-transparent">
                                    <X className="w-8 h-8 text-gray-300 group-hover:text-gray-800 group-hover:rotate-90 transition-all" />
                                </button>
                            </div>

                            <form onSubmit={handleSubmit} className="p-12 space-y-10 overflow-y-auto max-h-[75vh]">

                                <div className="space-y-3">
                                    <h4 className="text-[11px] font-black text-gray-400 uppercase tracking-widest pl-2">Section 01: Core Identity</h4>
                                    <div className="grid grid-cols-2 gap-8 p-8 bg-gray-50/50 rounded-[40px] border border-gray-100 shadow-inner">
                                        <div className="space-y-3">
                                ...
                                <div className="space-y-3">
                                    <h4 className="text-[11px] font-black text-gray-400 uppercase tracking-widest pl-2">Section 02: Status & Domain</h4>
                                ...
                                <div className="space-y-3">
                                    <h4 className="text-[11px] font-black text-gray-400 uppercase tracking-widest pl-2">Section 03: Financial & Background</h4>
                                    <div className="grid grid-cols-2 gap-8">
                                        <div className="space-y-3">
